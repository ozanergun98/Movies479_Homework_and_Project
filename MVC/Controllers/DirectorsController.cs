...
namespace MVC.Controllers
{
    public class DirectorsController : Controller
    {
        ...
        {
            DirectorModel director = _directorService.Query().SingleOrDefault(u => u.Id == id); // TODO: Add get item service logic here
			if (director == null)
            {
                return NotFound();
            }
        ...
        {
            DirectorModel director = _directorService.Query().SingleOrDefault(u => u.Id == id);
			if (director == null)
            {
                return NotFound();
            }
